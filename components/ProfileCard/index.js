...
//https://www.nhm.ac.uk/content/dam/nhmwww/discover/wild-cats/pallas-cat-face-close-up-full-width.jpg
    return(
        <Flex w='398px' h='573px' bgColor='rgba(255, 255, 255, 0.04)' boxShadow={'0px 4px 5px 1px rgba(0, 0, 0, 0.25)'} backdropFilter='blur(15px)' borderRadius='47px' p='2rem' flexDir='column' align='center'>
